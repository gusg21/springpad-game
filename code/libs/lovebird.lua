...
<html>
  ...
  <meta charset="utf-8">
  <title>lovebird (<?lua echo(lovebird.game_name) ?>)</title>
  <style>
    body {
      margin: 0px;
      font-size: 14px;
  ...
  <body>
    <div id="header">
      <div id="title">
        <a><?lua echo(lovebird.game_name) ?></a>
        <span id="version">game v<?lua echo(lovebird.game_version) ?> :: lb v<?lua echo(lovebird._version) ?> :: <b>Debugger</b></span>
      </div>
      <div id="status"></div>
    </div>
    <div id="main">
